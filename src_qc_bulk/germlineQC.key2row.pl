...
=head1 USAGE
    ...
    perl germlineQC.key2row.pl -cut list.txt content.txt -o out
    perl germlineQC.key2row.pl -lc 1 -cc 2 -keyN 2 -showList -showListAll list.txt content.txt -o out
    perl germlineQC.key2row.pl -lc 1 -cc 2 -keyN 2 -showList -showListAll -uniq list.txt content.txt -o out
