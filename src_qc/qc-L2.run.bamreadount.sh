...
$BAMREADCOUNT -q 10 -b 20 -f $GENOME -l $OUT/$SAMPLE.rc.loci $BAM > $OUT/$SAMPLE.brc

# call vaf 
perl $scriptDir/qc-L2.bamReadcount2vaf.pl -s $SAMPLE -l $LOCI $OUT/$SAMPLE.brc > $OUT/$SAMPLE.brc.vaf
